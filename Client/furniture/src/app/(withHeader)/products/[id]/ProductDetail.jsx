...
gap-8 my-10 px-4">
      ...
      <div>
        <div className="border rounded-lg shadow bg-white p-3">
          <img
            ...
            className="w-full h-[300px] md:h-[420px] object-contain rounded"
          />
        </div>
        ...
        <div className="flex gap-3 mt-4 flex-wrap">
          {data.product.productGallery?.map((img, index) => (
            <img
              ...
              className={`w-16 h-16 md:w-20 md:h-20 object-cover border rounded cursor-pointer 
      ...
      <div className="space-y-6">
        ...
        <div>
          <p className="text-sm text-gray-500">
            ...
            <span className="font-semibold">
              {data.product.inStocks}
            </span>
          </p>
        </div>

        <button
          className="w-full bg-black text-white py-3 rounded-full hover:bg-[#C09578] transition"
          onClick={addCart}
        >
          Add to Cart
        </button>
        ...
        <button
          className="w-full bg-red-800 text-white py-3 rounded-full hover:bg-[#C09578] transition"
          onClick={removeCart}
        >
          Remove from Cart
        </button>
